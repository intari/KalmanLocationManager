/**
 * Created by Dmitriy Kazimirov, e-mail:dmitriy.kazimirov@viorsan.com on 28.10.2017.
 * based off https://github.com/villoren/KalmanLocationManager, MIT license
 * https://stackoverflow.com/a/26144699/1063214
 */
package net.intari.KalmanLocationManager;
...
import static net.intari.KalmanLocationManager.KalmanLocationManager.KALMAN_PROVIDER;
import static net.intari.KalmanLocationManager.KalmanLocationManager.UseProvider;

/**
 * Created by Rena on 28/09/2014.
 */
class LooperThread extends Thread {
    public static final String TAG = KalmanLocationManager.class.getSimpleName();
